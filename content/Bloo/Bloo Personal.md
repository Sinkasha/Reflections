...
## Traits:
 - Principles / Important Traits:
	...
	- When I go adventuring, I will try *very hard* to make sure my teammates live. (Likely come from arc with the girl, year 321 ish)
...
- Blob will start the campaign in a Kenku's corpse. With a raven mask on. Because I don't *actually* have a head. 
...
- Spells (6 known + feature + 2 from feat, 4 1st level 3 2nd level 2 3rd level) (3 warlock known, 2 1st level)
	...
	- [[Silvery Barbs]] (feat) *("not even close")*
	- [[Misty Step]] (feat)
...
- Font of Magic (*2nd level sorc. feature*)
...
- Metamagic (*3rd level sorc. feature*)
...
- The Genie (*1st-level Genie Warlock feature*)
	- STRAWBERRY GENIE
...
- Bottled Respite (*1st-level Genie Warlock feature*)
...
- Genie's Wrath (*1st-level Genie Warlock feature*)
...
- Eldritch Invocations (*2nd-level Genie Warlock feature*)
	- **Agonizing Blast**
