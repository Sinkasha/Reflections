...
##### Changeling
Ability Scores: Charisma +2; Choose any other +1 (WIS)
...
Read and understand spoken Sylvan and Thieves' Cant
...
- Spells (6 known + feature + 2 from feat, 4 1st level 3 2nd level 2 3rd level) (3 warlock known, 2 1st level)
	...
	- [[Lightning Bolt]]
	- Counterspell
	- [[Detect Magic]] (Psionic Spells feature) (replace Arms of Hadar)
	- [[Dissonant Whispers]] (Psionic Spells feature)
	- [[Tasha's Mind Whip]] (Psionic Spells feature) (replace Calm Emotions)
	...
	- Thunderwave (warlock)
	- Summon Abberation (Psionic Spells feature)
	- Raulothim's Psychic Lance (Psionic Spells feature) (replace Evard's Black Tentacles)
	- Dimension Door
