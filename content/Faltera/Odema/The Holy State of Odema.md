...
Currently people of the Holy State of Odema primarily worship the gods of [[God of the Sun Clarus|Sun]], [[God of Fortune Aurus|Fortune]], and [[God of Order Lucht|Order]].

## Places
```dataviewjs
dv.table(["Place", "Blurb"], dv.pages('"Faltera/Odema" and -"Faltera/Odema/The Holy State of Odema.md" and -"Faltera/Odema/Odemian Internal Governance.md"').sort(a => a.title).map(a => [dv.fileLink(a.file.path,false,[a.title]), a.blurb]))
```