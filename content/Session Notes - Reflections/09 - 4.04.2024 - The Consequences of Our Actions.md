---
publish: true
modified: 2025-10-07T17:52:29.366-07:00
---
...
- Involved PCs:
  ...
  - [[Bloo]]
  - [[Lyra]]
- Previous session: [[08 - 2.29.2024 - A Journey of Self-Discovery (for half the table)]]

##### Past

- We travelled to Ashfall
- We bought stuff
- We found another green fish and a map to [[The Empire of Dagdra#Windrest|Windrest]] in Southern Dagra
...
- Tripped up and stole from 3 goblins in a trench coat who were bothering [[Derrick Fiskov]], the weapon shopkeeper
  - Stole a key with the Fusillan flag, teleport scroll, and some gems
  - The 3 goblins gave Derrick a fake [[The League of Larcenists|LoL]] calling card
- Learned of a rumor that LoL is going to attack Parli, causing a lot of imitation leagues to show up
- The Fusillan flag key unlocks a vault in Parli, which requires 2 keys, one of which was entrusted to the [[The Kingdom of Fusilla#Fiskov Family|Fiskov]] family
...
- Then attacked by the adopted son of Count Canonbury, [[Jeice]] and [[Petra von Alspar]], members of the LoL
  - It appears the LoL stole from the Count and the Count doesn't work for the League
  - The LoL wants fish crystals
  - Jeice and Petra both warp away before we can kill them, but they drop a card with the LoL callsign and the fish emblem on it that simply says "The Order will Prevail", as well as a [[The Fish Crystals|yellow fish]]
- We are now level 5

### [[The Kingdom of Fusilla#Ashfall|Ashfall]], Commercial District

- Sarah asks for Potion of Greater Restoration, alchemist dude can't make it
- Could find it in the capital, supplier is a dude named [[The Kingdom of Fusilla#Fiskov Family|Fiskov]]
...
- Go into weapon store
  ...
  - The storeowner looks disheveled, also a halfling
    ...
    - Storeowner: "I think they're part of some part of gang, I received one of these" : pulls out calling card of [[The League of Larcenists]]
...
- Walk around to the back behind the weapon store, it's dark and it's an alleyway, Bloo uses Light, there's a backdoor in one of the buildings that leads to the weapon store
  ...
  - Nim: "Where's the key from, what's important about it" ^06b005
    ...
    - Nim: "what does it unlock"
      ...
      - Fiskov family: [[Melina Fiskov]] (head of [[Halpyr’s Adventurers]]) (family of elves)
  ...
  - Bloo: "Why"
  - Shopkeeper: "It's not in the hands of someone it's entrusted", I am a Fiskov, [[Derrick Fiskov]], which means there's been a breach of security
  - Derrick: Clearly they stabbed me because they know who I am
  - Derrick has a sister, [[Fae Fiskov]], and a cousin [[Melina Fiskov]]
...
- Man: "You killed my father, [[Count Canonbury]]" "You stole his crystals, we want it"
...
- Woman: throws a card at Banana, Lyra and Bloo's Mage Hands sandwiches the card between them
  ...
  - According to Banana, it appears to be [[The League of Larcenists]] call sign, it's the real deal,
