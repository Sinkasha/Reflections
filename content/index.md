...
```dataviewjs
for (let group of dv.pages('-"Templates" and -"Session Notes - Reflections" and -"Bloo" and -"index.md" and -"Session Notes - Reflections.md" and -"History of Faltera" and -"DnD Spells" and -"DnD Spells.md"').groupBy(a => a.Type)) {
